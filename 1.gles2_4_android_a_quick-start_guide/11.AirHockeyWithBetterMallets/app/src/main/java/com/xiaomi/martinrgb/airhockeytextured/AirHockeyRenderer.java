...
import com.xiaomi.martinrgb.airhockeytextured.objects.Puck;
...
//    }
    ...
    @Override public void onSurfaceChanged(GL10 gl10, int width, int height) {
        ...
        //viewMatrix 目标数组，存储试图矩阵
        //第二个是 int rmOffset，代表偏移数值
        //eyeX eyeY eyeZ centerX centerY centerZ upX upY upZ
        //eye代表眼睛位置,center眼睛聚焦位置，up头指向的地方
        //Matrix.setLookAtM(viewMatrix,0,0f,1.2f,2.2f,0f,0f,0f,0f,1f,0f);
...
//        table.draw();
        ...
        Matrix.setLookAtM(viewMatrix,0,mXRotate,mYRotate,2.2f,0f,0f,0f,0f,1f,0f);
