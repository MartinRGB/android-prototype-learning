package com.xiaomi.martinrgb.airhockey3d;
...
import com.xiaomi.martinrgb.airhockey3d.util.LoggerConfig;
import com.xiaomi.martinrgb.airhockey3d.util.MatrixHelper;
import com.xiaomi.martinrgb.airhockey3d.util.ShaderHelper;
import com.xiaomi.martinrgb.airhockey3d.util.TextResourceReader;
...
//        }
    ...
    private static final SpringConfig mconfig = SpringConfig.fromOrigamiTensionAndFriction(180, 5);
    ...
    private void setSpringSystem() {
        ...
        mSpring.addListener(new SimpleSpringListener() {
            ...
            public void onSpringUpdate(Spring mSpring) {
                ...
                mScaleRatio = (float) SpringUtil.mapValueFromRangeToRange(value, 0, 1, 1, 1.2);
            }
        });
    }
