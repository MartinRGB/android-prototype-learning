...
public class ParticlesRenderer implements GLSurfaceView.Renderer {
    ...
    private int particleNumCount = 10000;
    ...
    @Override public void onDrawFrame(GL10 gl10) {
        ...
        redParticleEmitter.addParticles(particleSystem, currentTime, 5);
        greenParticleEmitter.addParticles(particleSystem, currentTime, 5);
        blueParticleEmitter.addParticles(particleSystem, currentTime, 5);
