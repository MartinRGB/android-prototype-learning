...
import com.example.martinrgb.censor_wallpaper.measurement.Point;
...
import com.example.martinrgb.censor_wallpaper.utils.Util;
...
public class CameraSurfaceView extends SurfaceView implements Callback,
	...
	public static final int AVERAGE_THREASHHOLD = 2;
	...
	private boolean _showEyes = true;
