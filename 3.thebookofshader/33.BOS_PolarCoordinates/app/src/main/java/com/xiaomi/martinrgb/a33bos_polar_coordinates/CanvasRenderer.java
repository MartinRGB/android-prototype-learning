...
import com.xiaomi.martinrgb.a33bos_polar_coordinates.objects.SimpleColor;
import com.xiaomi.martinrgb.a33bos_polar_coordinates.programs.SimpleShaderProgram;
...
public class CanvasRenderer  implements GLSurfaceView.Renderer{
    ...
    public void onDrawFrame(GL10 gl10){
        ...
        simpleShaderProgram.setUniforms(currentTime,screenWidth,screenHeight,(float) mSpringX.getCurrentValue(),(float) mSpringY.getCurrentValue());
