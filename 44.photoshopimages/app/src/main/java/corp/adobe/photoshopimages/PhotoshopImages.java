...
public class PhotoshopImages extends Activity
	...
	private String mServerNameText = new String("10.232.52.50");
	
	/** Server password to use */
	private String mServerPasswordText = new String("111111");
	...
	//Delete TitleBars Forever
    private void deleteTitleBars(){
		//Delete Title Bar
		this.requestWindowFeature(Window.FEATURE_NO_TITLE);
		this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
	}

    //Delete NavBars Forever
	@Override
